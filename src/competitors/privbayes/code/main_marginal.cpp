...
int main(int argc, char *argv[]) {
		...
		data_dir = "/Users/alaeddinelaouir/PhDProjects/SLIMViewTest/data/preprocessed/gendim/";
		...
		table tbl("/Users/alaeddinelaouir/PhDProjects/SLIMViewTest/data/preprocessed/" + dataset + "/", is_train, true);
